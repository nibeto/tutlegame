...
LPDIRECT3DTEXTURE9 CGamaClear::m_pTexture[MAX_TEXTURE_RESULT] = {};
//CBg*CTitle::m_pBg = NULL;
//=============================================================================
// Create関数
//=============================================================================
CGamaClear *CGamaClear::Create(void)
{
	//インスタンス
	CGamaClear*pGameClear = NULL;
	pGameClear = new CGamaClear;
	if (pGameClear != NULL)
	{
		pGameClear->Init();
...
HRESULT CGamaClear::Load(void)
{//load//読み込み
	CRenderer *pRenderer = CManeger::GetRenderer();
	LPDIRECT3DDEVICE9 pDevice = pRenderer->GetDevice();

	// 頂点情報を設定
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/GameClear.jpg", &m_pTexture[0]);
...
void CGamaClear::Update(void)
{
	...
	{
		Resulttype = CGamaClear::Result_Type_GameCrear;
		Resulttype = CGamaClear::Result_Type_MAX;
	...
	m_apScene2D[0]->SetNOMAL(D3DXVECTOR3(pos.x + 550.0f, pos.y, pos.z), 1250.0f, 750.0f);
	m_apScene2D[1]->SetNOMAL(pos, 1250.0f, 750.0f);

	if (m_mode == CManeger::MODE_GAMECLEAR)
	{
