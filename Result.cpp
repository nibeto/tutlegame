...
LPDIRECT3DTEXTURE9 CResult::m_pTexture[MAX_TEXTURE_RESULT] = {};
...
void CResult::Update(void)
{
	...
	{
		Resulttype = CResult::Result_Type_GameCrear;
		Resulttype = CResult::Result_Type_MAX;

	}
	if (pInputKeyboard->GetPress(DIK_O))
	{
		Resulttype = CResult::Result_Type_GAmeOver;
		Resulttype = CResult::Result_Type_MAX;
	...
	if (m_mode == CManeger::MODE_RESULT)
	{
